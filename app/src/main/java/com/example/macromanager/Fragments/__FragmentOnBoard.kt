...
class __FragmentOnBoard : Fragment(),__FragmentWelcomeListener,__FragmentAccountInformationListener,__FragmentUserBiometricsListener,__FragmentDietPlanListener,__UserRepositoryListener {
    ...
    override fun onRetrieveUserBiometrics(userBiometrics: __UserBiometrics) {
        ...
        pagerAdapter.addFragment(frgDietPlan)
        viewPager2.currentItem++
