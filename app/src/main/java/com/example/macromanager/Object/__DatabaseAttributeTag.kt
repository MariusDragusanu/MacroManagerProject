...
object __DatabaseAttributeTag {
   ...
   const val USER_DAY_HISTORY="dayHistory"
    ...
    const val FOOD_CATEGORY_ATTRIBUTE="category"
    const val FOOD_QUANTITY_ATTRIBUTE="quantity"
    const val FOOD_CALORIES_ATTRIBUTE="caloriesIn100UM"
    const val FOOD_PROTEIN_ATTRIBUTE="nprotein"
    const val FOOD_FATS_ATTRIBUTE="nfats"
    const val FOOD_CARBS_ATTRIBUTE="ncarbs"
    const val FOOD_FIBER_ATTRIBUTE="nfiber"
